...
<body>
  ...
  <p style="font-size: 30px; font-weight: bold; text-align: center;">ĐỒNG THÁP</p>
<p>Đồng Tháp là một tỉnh thuộc vùng đồng bằng sông Cửu Long, có diện tích lớn ở miền Tây Nam Bộ với cảnh quan thiên nhiên đa dạng, sông nước mênh mông, cùng với đồng ruộng và vườn trái cây rộng lớn.</p>
<video width="840" height="360" controls autoplay>
    <source src="images/dongthap.mp4" type="video/mp4">
</video>
<p>Đồng Tháp nổi tiếng với di sản văn hóa đặc sắc và lâu đời, như Chùa Gáo, một trong những điểm hành hương quan trọng. Nơi đây cũng có những cảnh đẹp tự nhiên như đồng lúa, vườn trái cây phong phú và dãy núi non cao.</p>

<p>Việc du lịch tại Đồng Tháp không chỉ giúp du khách thưởng ngoạn cảnh thiên nhiên đẹp mắt mà còn mang đến trải nghiệm văn hóa và hành hương độc đáo. Một số điểm đến nổi bật:</p>

<ul>
    <li>Chùa Gáo: Là một trong những ngôi chùa linh thiêng với lịch sử lâu đời, thu hút đông đảo du khách và người dân địa phương.</li>
    <li>Đồng lúa và vườn trái cây: Đồng Tháp được biết đến với cánh đồng lúa và các vườn trái cây đa dạng như xoài, dừa, và các loại trái cây nhiệt đới khác.</li>
    <li>Vùng ven biển: Là nơi có bãi cát trắng và nước biển trong xanh tuyệt vời.</li>
    <li>Hệ thống kênh rạch: Du khách có thể tham gia các chuyến thuyền trên các con kênh rạch để khám phá cuộc sống đặc trưng của người dân địa phương ven sông.</li>
</ul>

<p>Du lịch tại Đồng Tháp sẽ mang đến cho du khách một trải nghiệm tuyệt vời với vẻ đẹp thiên nhiên tuyệt vời và văn hóa độc đáo của vùng đất này.</p>
    ...
    <div class="boxtitle">ĐẶC SẢN ĐỒNG THÁP</div>
      <ul>
        <li><a href="https://toplist.vn/top-list/quan-bun-ca-ngon-o-an-giang-40963.htm"> Bún cá</a></li>
        <li><a href="https://sacojet.vn/ga-dot-o-thum/">Gà đốt lá trúc</a></li>
        <li><a href="https://mia.vn/cam-nang-du-lich/du-du-dam-ri-na-quan-ngon-phuc-vu-dac-san-an-giang-van-nguoi-me-8502">Đu đủ đâm</a></li>
        <li><a href="https://mia.vn/cam-nang-du-lich/dac-sac-quan-bo-tu-thieng-chau-doc-noi-danh-khap-vung-nui-sam-8483">Bò 7 núi</a></li>
        <li><a href="https://mia.vn/cam-nang-du-lich/thot-not-an-giang-thuc-qua-quy-gia-den-tu-thien-nhien-8521">Thốt nốt</a></li>
        <li><a href="https://mia.vn/cam-nang-du-lich/luu-ngay-7-quan-com-tam-long-xuyen-dam-bao-an-la-ghien-8270">Cơm tấm Long Xuyên</a></li>
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Đồng Tháp</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
...
// Xử lý tìm kiếm
              if (isset($_GET["kv"])) {
                ...
                if (isset($_GET["ngaybd"]) && $_GET["ngaybd"] !== "") {
                  $ngaybd = $_GET["ngaybd"];
                  $sql .= " AND ngaybd LIKE '%$ngaybd%'";
                }
              } else {
                // Nếu không có giá trị "kv" được cung cấp, hiển thị tất cả dữ liệu.
                $sql ="SELECT DISTINCT  diadiem.id, diadiem.matour, diadiem.tentour, diadiem.hinh, diadiem.gia, diadiem.ngaybd, diadiem.ngaykt, diadiem.giamgia, diadiem.thoigian
                FROM diadiem
                WHERE matour LIKE 'DT%';";
    ;
              }
