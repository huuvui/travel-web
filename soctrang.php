...
<body>
  <div class="container">
    ...
    <p style="font-size: 30px; font-weight: bold; text-align: center;">SÓC TRĂNG</p>
    <p>Tỉnh Sóc Trăng nằm ở vùng đồng bằng sông Cửu Long, miền tây Nam bộ Việt Nam. Với vị trí chiến lược ven biển và sông, tỉnh Sóc Trăng có lợi thế về nguồn lực thiên nhiên và giao thông, đồng thời cũng là nơi giao lưu văn hóa giữa các dân tộc.</p>
     <video width="840" height="360" controls autoplay>
      <source src="images/soctrang.mp4" type="video/mp4">
    </video>
   <p>Sóc Trăng là nơi giao thoa văn hóa đặc sắc của đa dạng các cộng đồng dân tộc, trong đó có cộng đồng người Hoa đông đảo, người Khmer đông đảo và các dân tộc thiểu số khác. Điều này tạo nên sự phong phú về truyền thống, văn hóa, tôn giáo và ẩm thực, tạo nên một nét đặc trưng độc đáo cho vùng đất này.</p>
<p>Ngoài văn hóa đa dạng, Sóc Trăng cũng có những điểm du lịch đáng chú ý như khu du lịch sinh thái Trà Sư với cánh đồng cỏ lau, những kênh rạch mênh mông, nơi trú ngụ của đàn én và các loài chim đa dạng khác. Thêm vào đó, bạn cũng có thể thăm các ngôi chùa lịch sử như Chùa Dơi, Chùa Dương Tạng, Chùa Thập Nguyên, nơi lưu giữ những giá trị văn hóa tâm linh đặc biệt của người dân địa phương.</p>
<p>Nông nghiệp cũng đóng vai trò quan trọng trong kinh tế của Sóc Trăng, với việc sản xuất nông sản như lúa, mía, hải sản, đặc biệt là các loại cá và tôm từ hệ thống ao nuôi ven biển.</p>
<p>Tóm lại, Sóc Trăng không chỉ có vẻ đẹp tự nhiên tuyệt vời mà còn đem lại trải nghiệm văn hóa đa dạng và phát triển bền vững trong lĩnh vực kinh tế, đặc biệt là nông nghiệp và du lịch.</p>
    ...
    <div class="boxtitle">ĐẶC SẢN SÓC TRĂNG</div>
      <ul>
        <li><a href="https://www.yong.vn/hu-tiu-ca-ri-vinh-chau-soc-trang-tvfd"> Hủ tíu cà ri</a></li>
        <li><a href="https://www.yong.vn/banh-ong-soc-trang-tvfd">Bánh ống Sóc Trăng</a></li>
        <li><a href="https://www.yong.vn/banh-pia-soc-trang-tvfd">Bánh Pía Sóc Trăng</a></li>
        <li><a href="https://www.yong.vn/bun-nuoc-leo-soc-trang-tvfd">Bún nước lèo </a></li>
        <li><a href="https://www.yong.vn/bun-goi-da-soc-trang-tvfd">Bún gỏi dà</a></li>
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Sóc Trăng</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
