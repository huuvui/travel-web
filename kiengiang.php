...
<body>
  <div class="container">
    ...
    <p style="font-size: 30px; font-weight: bold; text-align: center;">KIÊN GIANG</p>
    <p>Tỉnh Kiên Giang là một trong những địa điểm du lịch nổi tiếng và quan trọng ở Việt Nam. Đây là một tỉnh thuộc vùng Đồng bằng sông Cửu Long, tọa lạc ở cực Nam của Việt Nam, có biên giới với Campuchia.</p>
    <video width="840" height="360" controls autoplay>
      <source src="images/kiengiang.mp4" type="video/mp4">
    </video>
<p>Với địa hình đa dạng, Kiên Giang có các bãi biển tuyệt vời như Phú Quốc, Hòn Sơn, Hòn Tre, nơi thu hút du khách bởi cảnh đẹp tự nhiên tuyệt vời, bờ biển trong xanh và cát trắng. Đặc biệt, Phú Quốc là hòn đảo lớn nhất của Việt Nam, được biết đến với các khu nghỉ dưỡng sang trọng, cảnh đẹp thiên nhiên tuyệt vời và ngành công nghiệp du lịch phát triển mạnh mẽ.</p>
<p>Ngoài ra, Kiên Giang cũng có những di sản văn hóa đặc sắc với các ngôi đền, chùa như Chùa Dinh Cậu, Bãi Dứa, những ngôi nhà cổ truyền thống mang nét độc đáo của vùng đất này.</p>
<p>Ngoài các điểm du lịch, Kiên Giang còn nổi tiếng với ngành nông nghiệp, đặc biệt là trong lĩnh vực sản xuất nông sản như hải sản và mía. </p>
    ...
    <div class="boxtitle">ĐẶC SẢN KIÊN GIANG</div>
      <ul>
        <li><a href="https://mia.vn/cam-nang-du-lich/lau-chua-sa-nghe-ca-nham-giau-tinh-hoa-am-thuc-tay-nam-bo-11192"> Lẩu chua sả nghệ cá nhám giàu</a></li>
        <li><a href="https://mia.vn/cam-nang-du-lich/goi-ca-trich-va-huong-vi-dan-da-dam-chat-mien-bien-kien-giang-11201">Gỏi cá trích</a></li>
        <li><a href="https://vinpearl.com/vi/bun-quay-phu-quoc-dac-san-tru-danh-dao-ngoc">Bún quậy Phú Quốc</a></li>
        <li><a href="https://vinpearl.com/vi/ruou-sim-phu-quoc-dac-san-dao-ngoc-say-long-du-khach">Rượu sim Phú Quốc</a></li>
        <li><a href="https://vinpearl.com/vi/thu-ngay-com-ghe-phu-quoc-thom-ngon-dam-da-gay-nhung-nho">Cơm ghẹ Phú Quốc</a></li>
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Kiên Giang</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
