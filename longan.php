...
<body>
  <div class="container">
    ...
    <p style="font-size: 30px; font-weight: bold; text-align: center;">LONG AN</p>
    <p>Tỉnh Long An là một địa điểm đặc biệt ở miền Tây Nam Bộ Việt Nam, nổi tiếng với vùng đất màu mỡ, với các cánh đồng lúa non xanh mướt và hệ thống kênh rạch phong phú.</p>
  <video width="840" height="360" controls autoplay>
      <source src="images/longan.mp4" type="video/mp4">
    </video>
  <p>Về vị trí địa lý, Long An giáp với Thành phố Hồ Chí Minh, Đồng Tháp, Tiền Giang và Tây Ninh. Tỉnh này có một số điểm du lịch đáng chú ý như Vườn quốc gia Tràm Chim, nơi du khách có thể thưởng ngoạn đa dạng các loài chim và cảnh quan thiên nhiên hoang sơ. Ngoài ra, còn có Di tích lịch sử Vườn An Cựu và Đền thờ Cái Sơn.</p>
<p>Nền kinh tế của Long An tập trung chủ yếu vào nông nghiệp, với sản xuất lúa, ngô, đậu và hơn nữa, tỉnh này cũng nổi tiếng với việc chăn nuôi cá, tôm và vật nuôi khác. Ngoài ra, Long An cũng đang phát triển mạnh mẽ trong lĩnh vực công nghiệp và dịch vụ.</p>
<p>Với vùng đất phong phú, Long An không chỉ có tiềm năng phát triển kinh tế mà còn là nơi giữ gìn và phát huy những giá trị văn hóa truyền thống đặc sắc của miền Tây Nam Bộ Việt Nam.</p>
    ...
    <div class="boxtitle">ĐẶC SẢN LONG AN</div>
      <ul>
        <li><a href="https://kenh14.vn/bun-xiem-lo-mon-an-la-tai-la-mieng-hoa-ra-la-dac-san-ngon-kho-cuong-o-long-an-20220810102046811.chn"> Bún Xiêm Lo</a></li>
        <li><a href="https://vietflavour.com/san-pham/mam-cong-cha-can-giuoc/">Mắm còng Cần Giuộc</a></li>
        <li><a href="https://plo.vn/ve-long-an-thuong-thuc-huong-vi-banh-tet-vam-thu-trong-ngay-tet-post716660.html">Bánh tét Vàm Thủ</a></li>
        <li><a href="https://hitour.vn/tin-tuc-du-lich-long-an/dac-san-long-an/lap-xuong-tuoi-long-an">Lạp xưởng tươi</a></li>
        <li><a href="https://www.yong.vn/lau-mam-long-an-tvfd">Lẩu mắm</a></li>
   
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Long An</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
