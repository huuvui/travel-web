...
if ( ! function_exists( 'travel_booking_sidebar_layout' ) ) :
	...
	function travel_booking_sidebar_layout() {
		...
		if ( is_singular( 'trip' ) ) {
			...
			if ( is_active_sidebar( 'wte-sidebar-id' ) || ! empty( $wtetrip->packages ) || ( isset($wpte_option_setting['show_trip_facts_sidebar'] ) && $wpte_option_setting['show_trip_facts_sidebar'] == 'yes' ) || false == $hide_sidebar ) {
