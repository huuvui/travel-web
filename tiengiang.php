...
<body>
  <div class="container">
    ...
    <p style="font-size: 30px; font-weight: bold; text-align: center;">TIÈN GIANG</p>
    <p>Tỉnh Tiền Giang là một địa điểm đặc biệt ở miền Nam Việt Nam, nằm trong vùng Đồng bằng sông Cửu Long. Tỉnh này nổi tiếng với cảnh đẹp thiên nhiên tuyệt vời, nền văn hóa đa dạng và cũng là một trung tâm kinh tế quan trọng trong khu vực.</p>
   <video width="840" height="360" controls autoplay>
      <source src="images/tiengiang.mp4" type="video/mp4">
    </video>
    
<p>Tiền Giang có một số điểm du lịch hấp dẫn như Vườn quốc gia Tràm Chim, nơi mà du khách có cơ hội chiêm ngưỡng các loài chim quý hiếm và khám phá vùng đầm lầy thiên nhiên tuyệt vời. Ngoài ra, nơi đây còn có những khu di tích lịch sử văn hóa như Cung điện Thực Lăng, nơi lưu giữ những giá trị văn hóa đặc biệt của miền Nam.</p>

<p>Với hệ thống sông ngòi lớn như sông Tiền, sông Hậu, Tiền Giang là vùng đất mà sản xuất nông nghiệp phát triển mạnh mẽ. Đặc biệt, nơi đây nổi tiếng với sản xuất trái cây như xoài, mận, bưởi và các loại rau, nông sản khác.</p>

<p>Tỉnh Tiền Giang cũng có sự giao thoa văn hóa đặc sắc, từ các lễ hội truyền thống đến ẩm thực phong phú. Điều này tạo nên một môi trường đa dạng, thu hút khách du lịch tới đây để khám phá và tận hưởng vẻ đẹp tự nhiên cũng như trải nghiệm văn hóa độc đáo của vùng đất này.</p>
    ...
    <div class="boxtitle">ĐẶC SẢN TIỀN GIANG</div>
      <ul>
        <li><a href="https://www.yong.vn/hu-tieu-my-tho-tien-giang-tvfd"> Hủ tiếu Mỹ Tho</a></li>
        <li><a href="https://www.yong.vn/chao-ca-loc-rau-dang-tien-giang-tvfd">Cháo cá lóc rau đắng</a></li>
        <li><a href="https://www.yong.vn/banh-beo-cho-hang-bong-tien-giang-tvfd">Bánh bèo chợ Hàng Bông</a></li>
        <li><a href="https://www.yong.vn/banh-va-banh-gia-tien-giang-tvfd">Bánh vá (bánh giá) </a></li>
        <li><a href="https://www.yong.vn/oc-gao-tan-phong-tien-giang-tvfd">Ốc gạo Tân Phong</a></li>
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Tiền Giang</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
