...
<body>
  <div class="container">
    ...
    <p style="font-size: 30px; font-weight: bold; text-align: center;">TRÀ VINH</p>
    <p>Tỉnh Trà Vinh là một địa điểm nằm trong vùng Đồng bằng sông Cửu Long tại miền Nam Việt Nam. Vùng đất này đa dạng về văn hóa và lịch sử, với cộng đồng dân cư đa dạng, chủ yếu là người Kinh, Khmer, và Hoa.</p>
  <video width="840" height="360" controls autoplay>
      <source src="images/travinh.mp4" type="video/mp4">
    </video>
   <p>Trà Vinh nổi tiếng với cảnh đẹp thiên nhiên hùng vĩ, với hệ thực vật phong phú và các kênh rạch mêandering qua các vùng đồng bằng, tạo nên vẻ đẹp đặc trưng của vùng đất này.</p>
<p>Cộng đồng người Khmer ở Trà Vinh đã tạo ra một nền văn hóa độc đáo với những ngôi chùa linh thiêng, lễ hội truyền thống rực rỡ và nghệ thuật truyền thống độc đáo.</p>
<p>Những điểm đến như Chùa Ang, chùa Ông Met, hay lễ hội như Ok Om Bok, Chol Chnam Thmay là nơi du khách có thể tìm hiểu và trải nghiệm văn hóa đặc sắc của người Khmer.</p>
<p>Trà Vinh cũng nổi tiếng với sản xuất nông nghiệp như trồng lúa, dừa, mía và thủy sản, góp phần quan trọng vào nền kinh tế của khu vực và cả nước.</p>
<p>Tỉnh Trà Vinh với vẻ đẹp tự nhiên và nền văn hóa đặc sắc là điểm đến hấp dẫn cho du khách muốn khám phá cảnh đẹp thiên nhiên và tìm hiểu văn hóa đa dạng của miền Nam Việt Nam.</p>
    </div>
    ...
    <div class="boxtitle">ĐẶC SẢN TRÀ VINH</div>
      <ul>
        <li><a href="https://www.yong.vn/banh-canh-ben-co-tra-vinh-tvfd">Bánh canh Bến Có</a></li>
        <li><a href="https://www.yong.vn/bun-suong-tra-vinh-tvfd">Bún Suông</a></li>
        <li><a href="https://www.yong.vn/chu-u-tra-vinh-tvfd">Con chù ụ</a></li>
        <li><a href="https://www.yong.vn/dua-sap-cau-ke-tra-vinh-tvfd">Dừa sáp Cầu Kè</a></li>
        <li><a href="https://www.yong.vn/mam-bo-hoc-tra-vinh-tvfd">Mắm bò hóc</a></li>
      </ul>
    </div>
  </div>

  <p style="font-size: 28px; font-weight: bold; text-align: center;">Gợi ý những địa điểm du lịch Trà Vinh</p>
  <style>
              .tour-container {
                display: flex;
                flex-wrap: wrap;
